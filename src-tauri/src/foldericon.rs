...
const TEMPLATES: &[Template] = &[
    ...
    Template {
        ...
        args: &[
            ...
            "512x512!", "-blur", "0x8", "{ASSETS}/folderhorizontal-top.png", ")", "-compose",
    ...
    Template {
        ...
        args: &[
            "(", "-size", "512x512", "xc:none", ")", "-compose", "Over", "(", "{INPUT}", "-scale",
            "512x512!", "-blur", "0x8", "{ASSETS}/foldervertical-side.png", ")", "-compose",
    ...
    Template {
        ...
        args: &[
            ...
            "2x2!", "-resize", "200x200!", "-scale", "390x390!", "-gravity", "Center",
            "-modulate", "105,150", "-brightness-contrast", "-10x0", "-blur", "0x8",
            "-brightness-contrast", "5x20", "-modulate", "95,100", "{ASSETS}/Win11A-Back.png",
            "-scale", "512x512!", ")", "-compose", "over", "-composite", "(", "{INPUT}", "-resize",
            "2x2!", "-resize", "200x200!", "-scale", "390x390!", "-gravity", "Center",
            "-modulate", "100,150", "-blur", "0x8", "-brightness-contrast", "5x20",
    ...
    Template {
        ...
        args: &[
            ...
            "-modulate", "100,130", "-resize", "2x2!", "-resize", "200x200!", "-scale",
            "512x512!", "-gravity", "Center", "-blur", "0x8", "-brightness-contrast", "-5x0",
            "-brightness-contrast", "0x27", "-blur", "0x8", "{ASSETS}/BeOriginal-back.png", ")",
    ...
    Template {
        ...
        args: &[
            ...
            "900x900!", "-blur", "0x10", "-brightness-contrast", "0x30", "{ASSETS}/DiscArt-Border.png",
...
const MULTI_TEMPLATES: &[MultiTemplate] = &[
    MultiTemplate {
        ...
        passes: &[
            &[
                "(", "-size", "512x512", "xc:none", ")", "-compose", "Over", "(", "{INPUT}",
                "-resize", "3x3!", "-resize", "200x200!", "-scale", "512x512!", "-modulate",
                "100,130", "-brightness-contrast", "8x13", "-blur", "0x10", "{ASSETS}/DualTabV-Tab2.png",
