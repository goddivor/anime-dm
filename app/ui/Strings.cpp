...
constexpr Translation kTable[STR_COUNT] = {
    ...
    {L"L'extension Anime Download Manager doit être installée dans chaque navigateur coché ; "
     L"l'application s'y déclare à chaque démarrage.",
     L"The Anime Download Manager extension must be installed in each checked browser; "
     L"the application declares itself to them at every start."},
